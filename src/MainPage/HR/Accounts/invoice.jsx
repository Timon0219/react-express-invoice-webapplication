   ...
   render() {
    ...
    const columns = [
      ...
      },      
      {
        ...
        render: (text, record) => (
          <a href="/purple/app/accounts/invoices-view">#{text}</a>
          ),
        ...
        <div className="page-header">
          <div className="row align-items-center">
            ...
            <div className="col-auto float-right ml-auto">
              <a href="/purple/app/accounts/invoices-create" className="btn add-btn"><i className="fa fa-plus" /> Create Invoice</a>
            </div>
          </div>
        </div>
        {/* /Page Header */}
