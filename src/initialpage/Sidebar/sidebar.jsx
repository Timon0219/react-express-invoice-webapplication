          ...
          <div id="sidebar-menu" className="sidebar-menu">
            <ul>
              ...
              <li className="submenu">
                ...
                <ul style={{display: 'none'}}>
                  ...
                  <li><a className={pathname.includes('main/employee-') ?"active" :""} 
                        href="/purple/app/main/employee-dashboard">Employee Dashboard</a></li>
                </ul>
              </li>
              <li className="submenu">
              ...
              <li className="submenu">
                ...
                <ul style={{display: 'none'}}>
                  <li><a className={pathname.includes('allemployees') ?"active" :pathname.includes('employees-list') ?"active" :""} 
                        href="/purple/app/employee/allemployees">All Employees</a></li>
                  <li><a className={pathname.includes('holidays') ?"active" :""} href="/purple/app/employee/holidays">Holidays</a></li>
              ...
              <li className="submenu">
                ...
                <ul style={{display: 'none'}}>
                  ...
                  "active" : pathname.includes('cts-view' ) ? "active" : ""} 
                      href="/purple/app/projects/project_dashboard">Projects</a></li>
                  <li><a href="/purple/tasks/tasks">Tasks</a></li>
                  <li><a className={pathname.includes('task-board') ?"active" :""} href="/purple/app/projects/task-board">Task Board</a></li>
                </ul>
              </li>
              ...
              <li className="submenu">
                ...
                <ul style={{display: 'none'}}>
                  <li><a className={pathname.includes('estimates') ?"active" :""} href="/purple/app/accounts/estimates">Estimates</a></li>
                  <li><a className={pathname.includes('invoices') ?"active" :""} href="/purple/app/accounts/invoices">Invoices</a></li>
                  <li><a className={pathname.includes('payments') ?"active" :""} href="/purple/app/accounts/payments">Payments</a></li>
                  <li><a className={pathname.includes('expenses') ?"active" :""} href="/purple/app/accounts/expenses">Expenses</a></li>
                  <li><a className={pathname.includes('provident-fund') ?"active" :""} href="/purple/app/accounts/provident-fund">Provident Fund</a></li>
                  <li><a className={pathname.includes('taxes') ?"active" :""} href="/purple/app/accounts/taxes">Taxes</a></li>
                </ul>
              </li>
              <li className="submenu">
              ...
              <li className="submenu">
                ...
                <ul style={{display: 'none'}}>
                  <li><a className={pathname.includes('jobs') ?"active" :""} href="/purple/app/administrator/jobs"> Manage Jobs </a></li>
                  <li><a className={pathname.includes('job-applicants') ?"active" :""} href="/purple/app/administrator/job-applicants"> Applied Candidates </a></li>
                </ul>
              </li>
              ...
              <li className={pathname.includes('activities') ?"active" :""}> 
                <a href="/purple/app/administrator/activities"><i className="la la-bell" /> <span>Activities</span></a>
              </li>
              <li className={pathname.includes('administrator/users') ?"active" :""}> 
                <a href="/purple/app/administrator/users"><i className="la la-user-plus" /> <span>Users</span></a>
              </li>
              <li> 
